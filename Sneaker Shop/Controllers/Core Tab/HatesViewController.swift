...
class HatesViewController: UIViewController {
    ...
    private func configureContentCollectionView(){
        ...
        myCollectionView?.register(UINib(nibName: "HateCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "HateCollectionViewCell")
...
extension HatesViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "HateCollectionViewCell", for: indexPath) as! HateCollectionViewCell
...
extension HatesViewController: UICollectionViewDelegateFlowLayout{
...
extension HatesViewController: UITextFieldDelegate {
